 ...
 *
 */
public abstract class JavaxCommSerial implements SerialPortEventListener {
    ...
    private final static Logger logger = LoggerFactory.getLogger(JavaxCommSerial.class);

    public JavaxCommSerial() {
    ...
    protected void openSerialPort(String port, String appName, int timeout, int baudRate, int dataBits, int stopBits, int parity, int flowControl) throws PortInUseException, UnsupportedCommOperationException, TooManyListenersException, IOException {
        ...
        while (portList.hasMoreElements()) {
            ...
            logger.debug("Inspecting port {} of type {}",portId.getName(), portId.getPortType());
