...
public interface ConfigurationProperties {
    ...
    /**
     * Key to use to change the behavior of the ZigBee Base Driver when a duplicated MAC address is detected during the discovery<br>
     * Please refer to {@link DuplicateMacPolicy} for further details and accepted values.
     * @since 0.8.0
     */
    public static final String DISCOVERY_DUPLICATE_MAC_KEY = "it.cnr.isti.zigbee.driver.discovery.duplicate.mac.policy";

    /**
     * The default value for the {@link #DISCOVERY_DUPLICATE_MAC_KEY} property, that is <b>Coordinator</b>
     * @since 0.8.0
     */
    public static final DuplicateMacPolicy DISCOVERY_DUPLICATE_MAC = DuplicateMacPolicy.UPDATE;


    /**
     * The default value for the {@link #NETWORK_MODE_KEY} property, that is <b>Coordinator</b>
     */
    public final static NetworkMode NETWORK_MODE = NetworkMode.COORDINATOR;
    /**
