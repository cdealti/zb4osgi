 ...
 *
 */
public interface OnOffSwitch_inutile__ extends ZCLCluster {

	public Attribute getAttributeOnOff();

	public Response on(boolean disableDefaultResponse);
	public Response off(boolean disableDefaultResponse);
	public Response toggle(boolean disableDefaultResponse);
